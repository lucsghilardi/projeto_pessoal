...
import type { TimeReport } from "@/types/Time";
...
export default function TarefasRelatoriosPage() {
  ...
  const completedByProject = useMemo(() => {
    const groups = new Map<
      string,
      { color: string; tasks: TimeReport["completed_tasks"] }
    >();
  ...
  return (
    <div className="space-y-5">
      <DashboardPageHeader
        ...
        description="Quanto tempo cada projeto/cliente consumiu, o que foi entregue e onde seu tempo está indo."
        actions={
